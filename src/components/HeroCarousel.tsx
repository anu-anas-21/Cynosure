      ...
      <div className="relative">
        ...
        <div className="container-page relative">
          <div className="py-10 lg:py-16">
            ...
            <div
              key={index}
              className="max-w-xl animate-[fadein_0.5s_ease] bg-[#f7f7f7]/95 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.15)] sm:p-12 lg:min-h-[26rem]"
            >
              <h1 className="text-4xl font-light leading-[1.12] text-ink-600 sm:text-5xl">
                {slide.title}
              </h1>
